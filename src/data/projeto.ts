...
const colProjetos = [
    {
        nome: "Descubra sua Idade", 
        site: "https://descubra-sua-idade-pink.vercel.app/", 
        codigo: "https://github.com/mtrodrigo/descubraSuaIdade.git",
        image: Idade, 
        descricao: "Este projeto é uma aplicação React que calcula a sua idade com base na data de nascimento fornecida."},
    {
